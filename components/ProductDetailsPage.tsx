  ...
  return (
    <div className="container mx-auto px-4 py-8">
              ...
              {product.variants[selectedVariantIndex].images.map(
                (image, index) => (
                  <div className="embla__slide aspect-square" key={index}>
                    <Image
                      src={`${image}?tr=w-800,h-800,cm-pad_resize,bg-FFFFFF` || "/placeholder.svg"}
                      alt={product.name}
                      width={800}
                      height={800}
      ...
      <div className="mt-16">
        ...
        <div className="py-3">
          {/* here added grid added and wrapped in div */}
          <div className="prose grid grid-cols-2 max-w-none text-gray-600">
            <div>
              <h4 className="text-gray-600 font-thin mb-1 ">Fabric:</h4>
            ...
            <div>
              <h4 className="text-gray-600 font-thin mb-1">Type:</h4>
              <p className=" text-primary font-bold">
            ...
            {product.fabricSize && (
              <div>
                <h4 className="text-gray-600 font-thin mb-1">Fabric Size:</h4>
                <p className="text-primary font-bold">
                  {product.fabricSize ||
